...
from donkeycar.parts.cv import ImgGreyscale, ImgCanny, ImgGaussianBlur, ImgCrop, ImgStack, ImgMask
from donkeycar.parts.imu import Mpu6050
from donkeycar.parts.lidar import B0602Lidar
...
def drive(cfg, model_path=None, use_joystick=False):
    ...
    V.add(kl, inputs=['cam/image_array', 'imu/imu_vec'], 
    ...
    inputs=['cam/image_array', 'user/angle', 'user/throttle', 'user/mode', 'imu/imu_vec']
...
def train(cfg, tub_names, model_name):
    ...
    def rt(record):
        ...
        record['imu/imu_vec'] = np.array(ast.literal_eval(record['imu/imu_vec'].split('/')[-1]))
        return record
